...
/*
 * Per-module CAM_DBG() mask (bitfield of the CAM_* module ids). Off by default;
 * enable at runtime via /sys/module/cam_debug_util/parameters/debug_mdl, e.g.
 * `echo 0x3FFFFFF > .../debug_mdl` for all modules.
 */
