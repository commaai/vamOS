...
/* VAMOS: removed <linux/ion.h> — ION removed from mainline 5.10+ */
...
int cam_hw_cdm_probe(struct platform_device *pdev)
{
	...
	strscpy /* VAMOS: was strlcpy */(cpas_parms.identifier, "cpas-cdm", CAM_HW_IDENTIFIER_LENGTH);
...
/* VAMOS: platform_driver .remove returns void in mainline 6.x */
