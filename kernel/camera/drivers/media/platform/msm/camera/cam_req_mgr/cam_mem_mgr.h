 ...
 */
struct cam_mem_buf_queue {
	/* VAMOS: removed ion_handle *i_hdl — ION replaced with dma-heap */
 ...
 * @alloc_dev: device used for DMA allocations
...
struct cam_mem_table {
	...
	void *bitmap;
	size_t bits;
	/* VAMOS: replaced ion_client with alloc_dev for dma_alloc based allocation */
