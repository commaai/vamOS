...
static int cam_eeprom_init_subdev(struct cam_eeprom_ctrl_t *e_ctrl)
{
	...
	strscpy /* VAMOS: was strlcpy */(e_ctrl->device_name, CAM_EEPROM_NAME,
...
/* VAMOS: kernel 6.x i2c_driver .probe takes only client, no id param */
...
/* VAMOS: kernel 6.x i2c_driver .remove returns void */
...
/* VAMOS: kernel 6.x spi_driver .remove returns void */
...
static void cam_eeprom_platform_driver_remove(struct platform_device *pdev) /* VAMOS: was int, void in mainline 6.x */
{
	int                        i;
	struct cam_eeprom_ctrl_t  *e_ctrl;
	struct cam_hw_soc_info    *soc_info;
