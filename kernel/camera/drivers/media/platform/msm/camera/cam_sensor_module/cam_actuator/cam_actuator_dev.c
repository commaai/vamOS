...
static int cam_actuator_init_subdev(struct cam_actuator_ctrl_t *a_ctrl)
{
	...
	strscpy /* VAMOS: was strlcpy */(a_ctrl->device_name, CAMX_ACTUATOR_DEV_NAME,
...
/* VAMOS: mainline 6.x i2c probe takes only struct i2c_client * */
...
static void cam_actuator_platform_remove(struct platform_device *pdev) /* VAMOS: was int, void in mainline 6.x */
{
	int32_t rc = 0;
	struct cam_actuator_ctrl_t      *a_ctrl;
...
/* VAMOS: mainline 6.x i2c remove returns void */
