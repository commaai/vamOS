...
/* VAMOS: vendor SCM defines removed — not available in mainline */

static int csiphy_dump;
module_param(csiphy_dump, int, 0644);

/* VAMOS: vendor SCM API (scm_call2/SCM_SIP_FNID/SCM_ARGS) not in mainline;
 * stub to return -ENOSYS until qcom_scm integration is done */
