...
static int cam_sensor_init_subdev_params(struct cam_sensor_ctrl_t *s_ctrl)
{
	...
	strscpy /* VAMOS: was strlcpy */(s_ctrl->device_name, CAMX_SENSOR_DEV_NAME,
...
static void cam_sensor_platform_remove(struct platform_device *pdev) /* VAMOS: was int, void in mainline 6.x */
{
	int                        i;
	struct cam_sensor_ctrl_t  *s_ctrl;
