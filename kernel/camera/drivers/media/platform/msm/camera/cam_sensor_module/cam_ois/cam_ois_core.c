...
static int cam_ois_fw_download(struct cam_ois_ctrl_t *o_ctrl)
{
	...
	/* VAMOS: replaced CMA alloc with kvzalloc — cma_alloc not available to drivers in mainline 6.x */
	i2c_reg_setting.reg_setting = kvzalloc(
		sizeof(struct cam_sensor_i2c_reg_array) * total_bytes, GFP_KERNEL);
	...
	kvfree(i2c_reg_setting.reg_setting);
