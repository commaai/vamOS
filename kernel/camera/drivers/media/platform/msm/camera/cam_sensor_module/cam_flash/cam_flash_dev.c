...
static void cam_flash_platform_remove(struct platform_device *pdev) /* VAMOS: was int, void in mainline 6.x */
{
...
static int cam_flash_init_subdev(struct cam_flash_ctrl *fctrl)
{
	...
	strscpy /* VAMOS: was strlcpy */(fctrl->device_name, CAM_FLASH_NAME,
