...
static int32_t cam_csiphy_platform_probe(struct platform_device *pdev)
{
	...
	new_csiphy_dev->v4l2_dev_str.ops =
		&csiphy_subdev_ops;
	strscpy /* VAMOS: was strlcpy */(new_csiphy_dev->device_name, CAMX_CSIPHY_DEV_NAME,
	...
	strscpy /* VAMOS: was strlcpy */(cpas_parms.identifier, "csiphy", CAM_HW_IDENTIFIER_LENGTH);
...
static void cam_csiphy_device_remove(struct platform_device *pdev) /* VAMOS: was int, void in mainline 6.x */
{
