...
static int cam_ois_init_subdev_param(struct cam_ois_ctrl_t *o_ctrl)
{
	...
	strscpy /* VAMOS: was strlcpy */(o_ctrl->device_name, CAM_OIS_NAME,
...
/* VAMOS: i2c probe lost id param in mainline 6.x */
...
/* VAMOS: i2c remove returns void in mainline 6.x */
...
static void cam_ois_platform_driver_remove(struct platform_device *pdev) /* VAMOS: was int, void in mainline 6.x */
{
	int                             i;
	struct cam_ois_ctrl_t          *o_ctrl;
	struct cam_ois_soc_private     *soc_private;
